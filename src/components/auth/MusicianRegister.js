...
import { getAllInstruments, getAllSkillLevels, registerUser } from "./AuthManager";
import "./Auth.css";
  ...
  const handleRegister = (e) => {
    ...
    registerUser(newUser).then((res) => {
      if ("token" in res) {
        ...
        history.push("/musician-dashboard");
      }
    });
  };
